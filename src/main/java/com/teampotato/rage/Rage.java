...
public class Rage {
    ...
    public static final ForgeConfigSpec.ConfigValue<Float> MAX_DAMAGE_BONUS, BASIC_DAMAGE_BONUS;
    public static final ForgeConfigSpec.IntValue FULL_RAGE_VALUE, GAINED_RAGE_PER_HURT_OR_ATTACK;

    static {
        ForgeConfigSpec.Builder builder = new ForgeConfigSpec.Builder();
        builder.push("Rage");
        NOTIFY_PLAYER_ON_RAGE_CHANGE = builder.define("NotifyPlayerOnRageChange", true);
        BASIC_DAMAGE_BONUS = builder.defineInRange("BasicDamageBonus", 3.0F, 0.0F, Float.MAX_VALUE, Float.class);
        MAX_DAMAGE_BONUS = builder.defineInRange("MaxDamageBonus", 5.0F, 0.0F, Float.MAX_VALUE, Float.class);
